...
JWT validation middleware, User model, role catalog (alumno, docente, personal, admin), profile data, login/logout flow, role-based permission mixins.
