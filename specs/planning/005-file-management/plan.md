# 005-file-management — File Management
...
Attachment uploads on solicitudes (size/type validation, virus-scan hook), download permission checks, storage abstraction (local FS for dev, switchable in prod).
