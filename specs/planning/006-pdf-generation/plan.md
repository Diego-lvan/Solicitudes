# 006-pdf-generation — PDF Generation
...
WeasyPrint-based PDF rendering of approved solicitudes from a per-tipo template; download endpoint; signed URLs if needed.
