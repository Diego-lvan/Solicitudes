# 003-catalog-forms — Catalog & Dynamic Forms
...
TipoSolicitud catalog with dynamic form schema (FieldDefinition: text, textarea, select, file, date, etc.); admin CRUD for tipos and fields. Foundation for the user-facing form rendering in initiative 004.
