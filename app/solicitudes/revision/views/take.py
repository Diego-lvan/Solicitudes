"""Take view — moves CREADA → EN_PROCESO."""
...
class TakeView(ReviewerRequiredMixin, View):
    def post(self, request: HttpRequest, folio: str) -> HttpResponse:
        ...
        messages.success(request, "Solicitud tomada para revisión.")
        return redirect(
            reverse("solicitudes:revision:detail", kwargs={"folio": folio})
        )
